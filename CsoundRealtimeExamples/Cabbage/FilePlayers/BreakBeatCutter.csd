...
;gitableL	ftgen	2,0,0,1,gSfilepath,0,0,2
;gitableR	ftgen	2,0,0,1,gSfilepath,0,0,2
gitableL	ftgen	0,0,0,1,"808loop.wav",0,0,1
gitableR	ftgen	0,0,0,1,"808loop.wav",0,0,2
...
; aR	=	aL				; right channel same as left
 ...
 aptr	phasor	iBPS/(8)
 aL	tablei	aptr,gitableL,1
 aR	tablei	aptr,gitableR,1
