...
; aAmpEnv	cossegr		0, i(gkAAtt),1, i(gkADec), i(gkASus), 36000, i(gkASus),i(gkARel), 0	; SUSTAIN SEGMENT (36000) NECESSARY DUE TO cosseg BUG
 ...
 aL	poscil	ivel*aAmpEnv*gkAGain, (ifreq*sr*1.01)/(giTabLen*giBase), giTable
 aR	poscil	ivel*aAmpEnv*gkAGain, (ifreq*sr)/(giTabLen*giBase), giTable, 0.5	; OFFSET RIGHT CHANNEL PHASE FOR STEREO BREADTH 
 aL2	poscil	ivel*aAmpEnv*gkAGain, (ifreq*sr*1.01)/(giTabLen*giBase), giTable2
 aR2	poscil	ivel*aAmpEnv*gkAGain, (ifreq*sr)/(giTabLen*giBase), giTable2, 0.5	; OFFSET RIGHT CHANNEL PHASE FOR STEREO BREADTH 
