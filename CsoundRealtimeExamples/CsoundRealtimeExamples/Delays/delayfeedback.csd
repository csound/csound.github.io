...
gkdlt,ihdlt			FLslider 	"Delay Time (sec)",		.001,   1,   -1,    23,          iddlt,   490,     25,    5,  50
...
ih		 	FLbox  	"the 'Feedback Ratio' slider. A value of zero represents 0% of", 	1,      5,     14,    490,    15,     5, 100
ih		 	FLbox  	"the signal being fed back and a value of 1 represents 100% of", 	1,      5,     14,    490,    15,     5, 120
ih		 	FLbox  	"the signal being fed value. Negative values are also allowed ", 	1,      5,     14,    490,    15,     5, 140
ih		 	FLbox  	"and represent the signal being inverted as it is fed back.   ", 	1,      5,     14,    490,    15,     5, 160
ih		 	FLbox  	"The audible effect of this is most evident when working with ", 	1,      5,     14,    490,    15,     5, 180
ih		 	FLbox  	"very short delay times.                                      ", 	1,      5,     14,    490,    15,     5, 200
ih		 	FLbox  	"In this example the user can choose between a drum loop sound", 	1,      5,     14,    490,    15,     5, 220
ih		 	FLbox  	"file as input or the computer's live input. A gain control is", 	1,      5,     14,    490,    15,     5, 240
ih		 	FLbox  	"is provided to control the gain of the live input.           ", 	1,      5,     14,    490,    15,     5, 260
