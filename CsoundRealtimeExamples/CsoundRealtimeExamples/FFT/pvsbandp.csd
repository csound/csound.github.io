...
;SET INITIAL VALUES FOR SLIDERS 	|VALUE | HANDLE
			FLsetVal_i	500, 	ihlowcut
			FLsetVal_i	550, 	ihlowfull
			FLsetVal_i	1000, 	ihhighcut
			FLsetVal_i	900, 	ihhighfull
			FLsetVal_i	0, 	ihtype
...
;TEXT BOXES												TYPE | FONT | SIZE | WIDTH | HEIGHT | X | Y
ih		 	FLbox  	"                          pvsbandp                           ", 	1,      5,     14,    490,    15,     5,  0
ih		 	FLbox  	"-------------------------------------------------------------", 	1,      5,     14,    490,    15,     5,  20
ih		 	FLbox  	"pvsbandp is an implementation of a band pass filter using    ", 	1,      5,     14,    490,    15,     5,  40
...
ih		 	FLbox  	"      klowfull __________________________ khighfull          ", 	1,      5,     14,    490,    15,     5, 160
...
ih		 	FLbox  	" ________/                                    \\______________", 	1,      5,     14,    490,    15,     5, 280
ih		 	FLbox  	"        klowcut                       khighcut               ", 	1,      5,     14,    490,    15,     5, 300
...
ih		 	FLbox  	"The input parameter 'type' defines the shape of the cutoff   ", 	1,      5,     14,    490,    15,     5, 360
