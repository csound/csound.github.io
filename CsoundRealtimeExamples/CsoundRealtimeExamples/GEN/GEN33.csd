...
;SET INITIAL VALUES OF FLTK VALUATORS		VALUE | HANDLE
				...
				FLsetVal_i	0, 	ihphsb
				FLsetVal_i	3, 	ihpnc
				FLsetVal_i	0.25, 	ihstrc
				FLsetVal_i	0, 	ihphsc
				FLsetVal_i	4, 	ihpnd
				FLsetVal_i	0.125, 	ihstrd
				FLsetVal_i	0, 	ihphsd
				FLsetVal_i	5, 	ihpne
				FLsetVal_i	0.0625,	ihstre
				FLsetVal_i	0, 	ihphse
				FLsetVal_i	6, 	ihpnf
				FLsetVal_i	0.04, 	ihstrf
				FLsetVal_i	0, 	ihphsf
				FLsetVal_i	7, 	ihpng
				FLsetVal_i	0.02, 	ihstrg
				FLsetVal_i	0, 	ihphsg
				FLsetVal_i	8, 	ihpnh
				FLsetVal_i	0.01, 	ihstrh
				FLsetVal_i	0, 	ihphsh
				FLsetVal_i	9, 	ihpni
				FLsetVal_i	0.01, 	ihstri
				FLsetVal_i	0, 	ihphsi
				FLsetVal_i	10, 	ihpnj
				FLsetVal_i	0.01, 	ihstrj
				FLsetVal_i	0, 	ihphsj
				FLsetVal_i	1, 	ihnh
				FLsetVal_i	10, 	ihlh
				FLsetVal_i	0.9, 	ihr
...
;TEXT BOXES												TYPE | FONT | SIZE | WIDTH | HEIGHT | X | Y
ih		 	FLbox  	"                            GEN33                            ", 	1,      5,     14,    490,     20,    5,   0
...
instr	1	;UPDATES FUNCTION TABLE                    
	...
	if ktrig=1 then				;IF A PARAMETER FOR THE FUNCTION TABLE HAS BEEN CHANGED...
	  ...
	  ;CREATE THE GEN33 FUNCTION TABLE. 
	  ...
	  isrc	ftgen	1,0, -9,-2, 1,1,0, 1,2,0, 1,3,0
	  iwave	ftgen	2,0,4096, -33, isrc, i(gknh), i(gkr), 0
	...
	if gkOnOff=1 then			;IF ON/OFF BUTTON IS ON...
	 ...
	 a1	oscili	kamp,kfrq,iwave		;CREATE AN AUDIO OSCILLATOR THAT WILL USE THE GEN09 DESIGNED WAVEFORM
