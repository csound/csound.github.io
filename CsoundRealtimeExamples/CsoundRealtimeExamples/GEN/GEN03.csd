...
idInAmp				FLvalue	" ",       50,     17,    5, 525
idfrq				FLvalue	" ",       50,     17,    5, 575
idOutAmp			FLvalue	" ",       50,     17,    5, 625
...
gkc0,gihc0			FLslider 	"Coefficient 0",	-5,     5,    0,    23,   idc0,       490,      25,    5,   100
gkc1,gihc1			FLslider 	"Coefficient 1",	-5,     5,    0,    23,   idc1,       490,      25,    5,   150
gkc2,gihc2			FLslider 	"Coefficient 2",	-5,     5,    0,    23,   idc2,       490,      25,    5,   200
gkc3,gihc3			FLslider 	"Coefficient 3",	-5,     5,    0,    23,   idc3,       490,      25,    5,   250
gkc4,gihc4			FLslider 	"Coefficient 4",	-5,     5,    0,    23,   idc4,       490,      25,    5,   300
gkc5,gihc5			FLslider 	"Coefficient 5",	-5,     5,    0,    23,   idc5,       490,      25,    5,   350
gkc6,gihc6			FLslider 	"Coefficient 6",	-5,     5,    0,    23,   idc6,       490,      25,    5,   400
gkInAmp,ihInAmp		FLslider 	"Input Amplitude",	0,      1,    0,    23,   idInAmp,    490,      25,    5,   500
gkfrq,ihfrq			FLslider 	"Frequency",		20,  5000,   -1,    23,   idfrq,      490,      25,    5,   550
gkOutAmp,ihOutAmp	FLslider 	"Output Amplitude",	0,      1,    0,    23,   idOutAmp,   490,      25,    5,   600
...
;SET INITIAL VALUES OF FLTK VALUATORS		VALUE | HANDLE
				...
				FLsetVal_i	0, 	gihc3
				FLsetVal_i	0, 	gihc4
				FLsetVal_i	1, 	ihInAmp
				FLsetVal_i	0.1, 	ihOutAmp
...
instr	1	;
	...
	if ktrig=1 then				;IF A PARAMETER FOR THE FUNCTION TABLE HAS BEEN CHANGED...
	  ...
	  ifun	ftgen  1,0,1025,3,i(gkval1),i(gkval2),i(gkc0),i(gkc1),i(gkc2),i(gkc3),i(gkc4),i(gkc5),i(gkc6)
	endif					;END OF THIS CONDITIONAL BRANCH

	andx	poscil	gkInAmp, gkfrq, gisine				; sine wave to be distorted
	asig	tablei	(andx*0.5)+0.5, ifun, 1				; waveshaping
			out		asig*gkOutAmp
endin
