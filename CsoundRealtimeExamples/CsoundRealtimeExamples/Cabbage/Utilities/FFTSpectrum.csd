...
image bounds(0,305,600,145), plant("source"), colour(0,0,0,0)
{
...
checkbox bounds(  5,120,100,15), channel("Buzz"), text("GBuzz"), radiogroup(3)
...
rslider bounds(195, 50,90, 90), channel("NH"), text("Num. Harms."), textbox(1), valuetextbox(1), range(1,80,40,1,1), visible(0), identchannel("Buzz1ID")
...
image    bounds(  5,450,600,185), plant("filter"), colour(0,0,0,0)
{
