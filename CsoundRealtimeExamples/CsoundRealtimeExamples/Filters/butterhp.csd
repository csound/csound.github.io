...
;					LABEL           | WIDTH | HEIGHT | X | Y
				FLpanel	"butterhp/buthp",  500,    150,    0,  0
...
instr	1
	...
	START:
	aresL 		buthp 	asigL, kfreq, i(gkskip)	;FILTER EACH CHANNEL SEPARATELY
	aresR 		buthp 	asigR, kfreq, i(gkskip)	;FILTER EACH CHANNEL SEPARATELY
