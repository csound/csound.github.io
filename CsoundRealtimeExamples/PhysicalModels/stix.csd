...
;			LABEL     | WIDTH | HEIGHT | X | Y
		FLpanel	"stix",     500,    300,    0,  0

;BUTTONS				ON | OFF | TYPE | WIDTH | HEIGHT | X | Y | OPCODE | INS | STARTTIM | IDUR
gkOnOff,ihOnOff	FLbutton	"Hit!",	1,    0,    21,    200,     30,   150, 10,    0,     1,      0,       -1
...
ih		 	FLbox  	"                            stix                             ", 	1,       5,    14,    490,     20,    5,   0
ih		 	FLbox  	"-------------------------------------------------------------", 	1,       5,    14,    490,     20,    5,  20
ih		 	FLbox  	"'stix' is a semi-physical model of the sound of sticks       ", 	1,       5,    14,    490,     20,    5,  40
ih		 	FLbox  	"colliding. It is one of the PhISEM percussion opcodes. PhISEM", 	1,       5,    14,    490,     20,    5,  60
