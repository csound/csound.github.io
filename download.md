...
<div style="line-height: 1.1em">
	...
	<a href="{{ site.data.download.windows_64_full.link }}">Windows 64bit v{{ site.data.download.windows_64_full.ver }}</a><br/>
	<a href="{{ site.data.download.windows_64.link }}">Windows 64bit v{{ site.data.download.windows_64.ver }}</a><br/>
